...
export class TranslationService {
  ...
  async translateUrl(data: TranslateUrlRequest): Promise<string> {
    ...
    // Not a products page - simple translation
  ...
  private async translateProductsUrl(
    ...
    // OPTIMIZATION: Only fetch attributes if we have attribute-like query params
...
//     // Translate query parameters
//     const subcategoryId = this.findSubcategoryId(segments, sourceCategories);
//     const translatedParams = await this.translateQueryParams(
//       searchParams,
//       subcategoryId,
//       sourceLang,
//       targetLang,
...
//     // Get attributes if we have a subcategory
//     let sourceAttributes: any[] = [];
//     let targetAttributes: any[] = [];

//     if (subcategoryId) {
//       [sourceAttributes, targetAttributes] = await Promise.all([
//         this.getAttributesForSubcategory(subcategoryId, sourceLang),
//         this.getAttributesForSubcategory(subcategoryId, targetLang),
//       ]);
//     }
